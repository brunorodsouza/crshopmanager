        ...
        <form action='{{route('veiculo.store')}}' method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control" minlength="4" maxlength="4" id="ano_fab" name="ano_fab">
                </div>

                <div class="col-md-2">
                    <label class="form-label" for="ano_mod">Ano Modelo: </label>
                    <input type="number" class="form-control" minlength="4" maxlength="4" id="ano_mod" name="ano_mod">
                </div>
