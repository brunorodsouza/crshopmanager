...
?>
            ...
            <form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <label class="form-label" for="modelo">Serviço: </label>
                        <input type="text" class="form-control" id="modelo" value="{{$d->servico->titulo}}" disabled>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" for="codigo">Veículo: </label>
                        <input type="text" class="form-control" id="codigo" value="{{$d->veiculo->placa}}" disabled>
                    </div>
                </div>
